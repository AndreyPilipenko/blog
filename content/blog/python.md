+++
title = "Python для співбесіди: повна база з поясненнями та прикладами"
date = "2023-06-16"
draft = false
tags = ["python", "programming"]
description = "Все що треба знати з Python щоб впевнено пройти технічну співбесіду: змінні, структури даних, ООП, бібліотеки, REST API. З поясненнями чому саме так і реальними прикладами."
+++
